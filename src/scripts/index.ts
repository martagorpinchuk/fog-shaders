import { Clock, Color, Mesh, MeshBasicMaterial, PerspectiveCamera, PlaneBufferGeometry, Raycaster, Scene, Vector2, Vector3, WebGLRenderer } from "three";
...
class FogScene {
    ...
    public init() : void {
        ...
        // this.mouseMoveFog( props );
        // this.clickFog( props );

        // this.mouseMoveFog( props, 'click' );
        ...
        fogParam.addInput( this, 'fogMovement' ).on( 'change', ( ev ) => {
            ...
            this.fogMovement = ev.value;
            console.log(this.fogMovement);

            if ( this.fogMovement ) {

                let movementProp = 'mousemove';
                // this.removeEventListenerFog( props, 'click' );
                ...
                // this.removeEventListenerFog( props, 'mousemove' );
    ...
    private addRaycasterPointer = ( event ) : void => {
        ...
        this.fog.soursePosition.set( intersects[0].point.x, 0.5, intersects[0].point.z );
